...
public interface IProductManagerLocal{
    ...
    PartLink getPartLinkFiltered(PartLink rootUsageLink, PSFilter filter, Integer pDepth) throws ConfigurationItemNotFoundException, WorkspaceNotFoundException, NotAllowedException, UserNotFoundException, UserNotActiveException, PartUsageLinkNotFoundException, AccessRightException ;
    ...
    List<PartLink> decodePath(String workspaceId, String path) throws UserNotFoundException, UserNotActiveException, WorkspaceNotFoundException, PartUsageLinkNotFoundException;
}
